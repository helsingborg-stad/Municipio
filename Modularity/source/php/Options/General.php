...
class General extends \Modularity\Options
{
    ...
    {
        global $modularityOptions;
        $enabled = isset($modularityOptions['enabled-post-types']) && is_array($modularityOptions['enabled-post-types'])
    ...
    public function metaBoxModules()
    {
        ...
        global $modularityOptions;
        $enabled = isset($modularityOptions['enabled-modules']) && is_array($modularityOptions['enabled-modules'])
