...
class Audio extends \Modularity\Module
{
    ...
    public function data(): array
    {
        ...
        $data['url'] = $fields['mod_audio_filetype'] === 'local'
            ? $fields['mod_audio_local_file']
            : $fields['mod_audio_external_audio_url'];
        $data['alignment'] = $fields['mod_audio_alignment'] ?? 'start';
        $data['acceptanceLabels'] = $data['requiresAcceptance']
            ? \Modularity\Helper\AcceptanceLabels::getLabels()
            : null;
