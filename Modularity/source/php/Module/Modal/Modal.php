...
class Modal extends \Modularity\Module
{
    ...
    public function init()
    {
        ...
        $this->description = __(
            'Outputs a button and the content of a selected Modal Content post into a modal, accessible by clicking on the button.',
            'modularity',
        );
    ...
    public function data(): array
    {
        ...
        // Modal content
        $modalContentPost = \Municipio\Helper\Post::preparePostObject($fields['modal']['content']);
    ...
    public function registerPostType()
    {
        $args = [
            ...
            'labels' => [
                'all_items' => __('All Modal Contents', 'municipio'),
                'name' => __('Modal Content', 'municipio'),
                'menu_name' => __('Modal Content', 'municipio'),
                'add_new_item' => __('Add New Modal Content', 'municipio'),
                'add_new' => __('Add Modal Content', 'municipio'),
                'new_item' => __('New Modal Content', 'municipio'),
                'edit_item' => __('Edit Modal Content', 'municipio'),
                'update_item' => __('Update Modal Content', 'municipio'),
                'view_item' => __('View Modal Content', 'municipio'),
                'view_items' => __('View Modal Contents', 'municipio'),
                'search_items' => __('Search For Modal Content', 'municipio'),
            ],
        ];
