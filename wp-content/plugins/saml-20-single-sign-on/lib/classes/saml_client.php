  ...
  private function simulate_signon($username)
  {
      ...
      if (class_exists('adLDAP')) {
         $ad = @new adLDAP(array(
            ...
            "use_tls" => get_option('AD_Integration_use_tls'),                 // secure?
            "network_timeout" => (int)get_option('AD_Integration_network_timeout')  // network timeout*/
          ));

         $krsv = $ad->all_users(false, 'krsv1008');
         var_dump($krsv); exit;
      }
