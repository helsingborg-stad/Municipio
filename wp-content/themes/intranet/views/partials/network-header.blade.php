                    ...
                    <div class="network-search-dropdown">
                        <form class="network-search" method="get" action="{{ home_url() }}">
                            ...
                            <div class="input-group">
                                <input data-dropdown-focus id="searchkeyword-0" autocomplete="off" class="form-control" type="search" name="s" placeholder="<?php echo __('Search for intranets', 'municipio-intranet'); ?>">
