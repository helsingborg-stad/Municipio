                                ...
                                <div class="grid-xs-6">
                                    @if(get_option('algolia_powered_by_enabled') != "no")
                                        <div class="gutter gutter-sm gutter-top text-right">
                                            <a href="http://algolia.com" rel="nofollow" class="algolia-powered-by-link"
                                               title="Algolia">
                                                <svg style="height: 18px;" viewBox="0 0 130 21"
                                                     xmlns="http://www.w3.org/2000/svg"><title>
                                                        search-by-algolia-white</title>
...
@verbatim
    <script type="text/html" id="tmpl-instantsearch-hit">
        <div class="ais-hits--content is-{{ data.post_status }}">
            ...
            <div class="suggestion-post-content"><?php _e("This post is not publicly avabile, you will be prompted to login to view this post.",
                    'municipio'); ?></div>
            <# } else { #>
            <div class="suggestion-post-content">
                <# var displayPostTypes = <?php echo $displayPostTypes; ?>; #>
                <# if (data.post_type_label && displayPostTypes.length && displayPostTypes.indexOf(data.post_type) !=
                -1) { #>
