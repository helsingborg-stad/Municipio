...
<div class="{{ $columnSize }} u-mb-4">
    <a href="{{ the_permalink() }}" class="box box-news-circular no-color brick-columns-{{$gridSize}}">
        @if ($thumbnail)
        <div class="box-image-container" {!! $thumbnail ? 'style="background-image:url(' . $thumbnail . ');"' : '' !!}>
