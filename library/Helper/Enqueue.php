...
class Enqueue {
     ...
     * @param null|array|EnqueueTranslation $localize Optional localization data as one or more (array) EnqueueTranslation instances.
     ...
     */
    public function add(string $handle, string $src, array $deps = [], null|array|EnqueueTranslation $localize = null, ?bool $module = null) {
        ...
        if (is_a($localize, EnqueueTranslation::class)) {
          ...
          foreach ($localize as $translation) {
            if (is_a($translation, EnqueueTranslation::class)) {
              $func['localize']($handle, $translation->getObjectName(), $translation->getTranslations());
            }
          }
        }
