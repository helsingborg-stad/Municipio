...
class ApplyI18n
{
    ...
    private function getTranslationForString(string $string): string
    {
        ...
        return match ($string) {
            ...
            'Popover' => $this->wpService->_x('Popover', 'design-builder-component-data', 'municipio'),
            'Color settings for dropdown and extended navigation panels.' => $this->wpService->_x('Color settings for dropdown and extended navigation panels.', 'design-builder-component-data', 'municipio'),
            'Popover Color Scheme' => $this->wpService->_x('Popover Color Scheme', 'design-builder-component-data', 'municipio'),
            'Sets the dropdown panel background, contrast, hover, and border colors together.' => $this->wpService->_x('Sets the dropdown panel background, contrast, hover, and border colors together.', 'design-builder-component-data', 'municipio'),
            'The Popover component provides a simple way to add popovers.' => $this->wpService->_x('The Popover component provides a simple way to add popovers.', 'design-builder-component-data', 'municipio'),
            'Site selector' => $this->wpService->_x('Site selector', 'design-builder-component-data', 'municipio'),
            'Size' => $this->wpService->_x('Size', 'design-builder-component-data', 'municipio'),
            'Controls the height using the same small, medium, and large steps as filled buttons.' => $this->wpService->_x('Controls the height using the same small, medium, and large steps as filled buttons.', 'design-builder-component-data', 'municipio'),
            'Small' => $this->wpService->_x('Small', 'design-builder-component-data', 'municipio'),
            'Medium' => $this->wpService->_x('Medium', 'design-builder-component-data', 'municipio'),
            'Large' => $this->wpService->_x('Large', 'design-builder-component-data', 'municipio'),
            'Border radius' => $this->wpService->_x('Border radius', 'design-builder-component-data', 'municipio'),
            'The Site selector component provides a compact way to switch between sites or audiences.' => $this->wpService->_x('The Site selector component provides a compact way to switch between sites or audiences.', 'design-builder-component-data', 'municipio'),
            default => $string,
        };
    }
