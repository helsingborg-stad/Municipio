...
class ApplyI18n implements DecoratorInterface
{
    ...
    private function getTranslationForString(string $text): ?string
    {
        return match ($text) {
            ...
            'Palette 1 Border' => $this->wpService->_x('Palette 1 Border', 'design-builder-token-data', 'municipio'),
            'Manual companion token for palette 1 border and hover states.' => $this->wpService->_x('Manual companion token for palette 1 border and hover states.', 'design-builder-token-data', 'municipio'),
            'Palette 1 Alt' => $this->wpService->_x('Palette 1 Alt', 'design-builder-token-data', 'municipio'),
            'Manual companion token for subtle palette 1 surfaces.' => $this->wpService->_x('Manual companion token for subtle palette 1 surfaces.', 'design-builder-token-data', 'municipio'),
            ...
            'Palette 2 Border' => $this->wpService->_x('Palette 2 Border', 'design-builder-token-data', 'municipio'),
            'Manual companion token for palette 2 border and hover states.' => $this->wpService->_x('Manual companion token for palette 2 border and hover states.', 'design-builder-token-data', 'municipio'),
            'Palette 2 Alt' => $this->wpService->_x('Palette 2 Alt', 'design-builder-token-data', 'municipio'),
            'Manual companion token for subtle palette 2 surfaces.' => $this->wpService->_x('Manual companion token for subtle palette 2 surfaces.', 'design-builder-token-data', 'municipio'),
            ...
            'Palette 3 Border' => $this->wpService->_x('Palette 3 Border', 'design-builder-token-data', 'municipio'),
            'Manual companion token for palette 3 border and hover states.' => $this->wpService->_x('Manual companion token for palette 3 border and hover states.', 'design-builder-token-data', 'municipio'),
            ...
            'Manual companion token for subtle palette 4 surfaces.' => $this->wpService->_x('Manual companion token for subtle palette 4 surfaces.', 'design-builder-token-data', 'municipio'),
            ...
            'Palette 5 Border' => $this->wpService->_x('Palette 5 Border', 'design-builder-token-data', 'municipio'),
            'Manual companion token for palette 5 border and hover states.' => $this->wpService->_x('Manual companion token for palette 5 border and hover states.', 'design-builder-token-data', 'municipio'),
            'Palette 5 Alt' => $this->wpService->_x('Palette 5 Alt', 'design-builder-token-data', 'municipio'),
            'Manual companion token for subtle palette 5 surfaces.' => $this->wpService->_x('Manual companion token for subtle palette 5 surfaces.', 'design-builder-token-data', 'municipio'),
            ...
            'Palette 6 Border' => $this->wpService->_x('Palette 6 Border', 'design-builder-token-data', 'municipio'),
            'Manual companion token for palette 6 border and hover states.' => $this->wpService->_x('Manual companion token for palette 6 border and hover states.', 'design-builder-token-data', 'municipio'),
            'Palette 6 Alt' => $this->wpService->_x('Palette 6 Alt', 'design-builder-token-data', 'municipio'),
            'Manual companion token for subtle palette 6 surfaces.' => $this->wpService->_x('Manual companion token for subtle palette 6 surfaces.', 'design-builder-token-data', 'municipio'),
            ...
            'Palette 7 Border' => $this->wpService->_x('Palette 7 Border', 'design-builder-token-data', 'municipio'),
            'Manual companion token for palette 7 border and hover states.' => $this->wpService->_x('Manual companion token for palette 7 border and hover states.', 'design-builder-token-data', 'municipio'),
            'Palette 7 Alt' => $this->wpService->_x('Palette 7 Alt', 'design-builder-token-data', 'municipio'),
            'Manual companion token for subtle palette 7 surfaces.' => $this->wpService->_x('Manual companion token for subtle palette 7 surfaces.', 'design-builder-token-data', 'municipio'),
            'Font Size 100' => $this->wpService->_x('Font Size 100', 'design-builder-token-data', 'municipio'),
            'Base font size.' => $this->wpService->_x('Base font size.', 'design-builder-token-data', 'municipio'),
            'Palette 8 Border' => $this->wpService->_x('Palette 8 Border', 'design-builder-token-data', 'municipio'),
            'Manual companion token for palette 8 border and hover states.' => $this->wpService->_x('Manual companion token for palette 8 border and hover states.', 'design-builder-token-data', 'municipio'),
            'Palette 8 Alt' => $this->wpService->_x('Palette 8 Alt', 'design-builder-token-data', 'municipio'),
            'Manual companion token for subtle palette 8 surfaces.' => $this->wpService->_x('Manual companion token for subtle palette 8 surfaces.', 'design-builder-token-data', 'municipio'),
            ...
            'Palette 9 Border' => $this->wpService->_x('Palette 9 Border', 'design-builder-token-data', 'municipio'),
            'Manual companion token for palette 9 border and hover states.' => $this->wpService->_x('Manual companion token for palette 9 border and hover states.', 'design-builder-token-data', 'municipio'),
            'Palette 9 Alt' => $this->wpService->_x('Palette 9 Alt', 'design-builder-token-data', 'municipio'),
            'Manual companion token for subtle palette 9 surfaces.' => $this->wpService->_x('Manual companion token for subtle palette 9 surfaces.', 'design-builder-token-data', 'municipio'),
            ...
            'Palette 10 Border' => $this->wpService->_x('Palette 10 Border', 'design-builder-token-data', 'municipio'),
            'Manual companion token for palette 10 border and hover states.' => $this->wpService->_x('Manual companion token for palette 10 border and hover states.', 'design-builder-token-data', 'municipio'),
            'Palette 10 Alt' => $this->wpService->_x('Palette 10 Alt', 'design-builder-token-data', 'municipio'),
            'Manual companion token for subtle palette 10 surfaces.' => $this->wpService->_x('Manual companion token for subtle palette 10 surfaces.', 'design-builder-token-data', 'municipio'),
            ...
            'Brand Palette' => $this->wpService->_x('Brand Palette', 'design-builder-token-data', 'municipio'),
            'Optional brand palette slots for reusable campaign and accent colors.' => $this->wpService->_x('Optional brand palette slots for reusable campaign and accent colors.', 'design-builder-token-data', 'municipio'),
            'Palette 1' => $this->wpService->_x('Palette 1', 'design-builder-token-data', 'municipio'),
            'Palette 1 Contrast' => $this->wpService->_x('Palette 1 Contrast', 'design-builder-token-data', 'municipio'),
            'Palette 2' => $this->wpService->_x('Palette 2', 'design-builder-token-data', 'municipio'),
            'Palette 2 Contrast' => $this->wpService->_x('Palette 2 Contrast', 'design-builder-token-data', 'municipio'),
            'Palette 3' => $this->wpService->_x('Palette 3', 'design-builder-token-data', 'municipio'),
            'Palette 3 Contrast' => $this->wpService->_x('Palette 3 Contrast', 'design-builder-token-data', 'municipio'),
            'Palette 4' => $this->wpService->_x('Palette 4', 'design-builder-token-data', 'municipio'),
            'Palette 4 Contrast' => $this->wpService->_x('Palette 4 Contrast', 'design-builder-token-data', 'municipio'),
            'Palette 5' => $this->wpService->_x('Palette 5', 'design-builder-token-data', 'municipio'),
            'Palette 5 Contrast' => $this->wpService->_x('Palette 5 Contrast', 'design-builder-token-data', 'municipio'),
            'Palette 6' => $this->wpService->_x('Palette 6', 'design-builder-token-data', 'municipio'),
            'Palette 6 Contrast' => $this->wpService->_x('Palette 6 Contrast', 'design-builder-token-data', 'municipio'),
            'Palette 7' => $this->wpService->_x('Palette 7', 'design-builder-token-data', 'municipio'),
            'Palette 7 Contrast' => $this->wpService->_x('Palette 7 Contrast', 'design-builder-token-data', 'municipio'),
            'Palette 8' => $this->wpService->_x('Palette 8', 'design-builder-token-data', 'municipio'),
            'Palette 8 Contrast' => $this->wpService->_x('Palette 8 Contrast', 'design-builder-token-data', 'municipio'),
            'Palette 9' => $this->wpService->_x('Palette 9', 'design-builder-token-data', 'municipio'),
            'Palette 9 Contrast' => $this->wpService->_x('Palette 9 Contrast', 'design-builder-token-data', 'municipio'),
            'Palette 10' => $this->wpService->_x('Palette 10', 'design-builder-token-data', 'municipio'),
