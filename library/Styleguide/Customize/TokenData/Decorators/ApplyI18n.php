...
class ApplyI18n implements DecoratorInterface
{
    ...
    private function getTranslationForString(string $text): ?string
    {
        return match ($text) {
            ...
            'Colors' => $this->wpService->_x('Colors', 'design-builder-token-data', 'municipio'),
            'Primary Variant' => $this->wpService->_x('Primary Variant', 'design-builder-token-data', 'municipio'),
            'Selects the token family used for primary button variants.' => $this->wpService->_x('Selects the token family used for primary button variants.', 'design-builder-token-data', 'municipio'),
            'Secondary Variant' => $this->wpService->_x('Secondary Variant', 'design-builder-token-data', 'municipio'),
            'Selects the token family used for secondary button variants.' => $this->wpService->_x('Selects the token family used for secondary button variants.', 'design-builder-token-data', 'municipio'),
            'Default Variant' => $this->wpService->_x('Default Variant', 'design-builder-token-data', 'municipio'),
            'Selects the token family used for default button variants.' => $this->wpService->_x('Selects the token family used for default button variants.', 'design-builder-token-data', 'municipio'),
            'Chat' => $this->wpService->_x('Chat', 'design-builder-token-data', 'municipio'),
            'Border radius multiplier' => $this->wpService->_x('Border radius multiplier', 'design-builder-token-data', 'municipio'),
            'Scales the border radius locally without changing the global border radius scale.' => $this->wpService->_x('Scales the border radius locally without changing the global border radius scale.', 'design-builder-token-data', 'municipio'),
            'Form' => $this->wpService->_x('Form', 'design-builder-token-data', 'municipio'),
            'Border settings' => $this->wpService->_x('Border settings', 'design-builder-token-data', 'municipio'),
            'Border radius multiplier' => $this->wpService->_x('Border radius multiplier', 'design-builder-token-data', 'municipio'),
            'Scales the border radius locally without changing the global border radius scale.' => $this->wpService->_x('Scales the border radius locally without changing the global border radius scale.', 'design-builder-token-data', 'municipio'),
            'Border width' => $this->wpService->_x('Border width', 'design-builder-token-data', 'municipio'),
            'Corner shape' => $this->wpService->_x('Corner shape', 'design-builder-token-data', 'municipio'),
            'Border color' => $this->wpService->_x('Border color', 'design-builder-token-data', 'municipio'),
            'Placeholder settings' => $this->wpService->_x('Placeholder settings', 'design-builder-token-data', 'municipio'),
            'Placeholder font family' => $this->wpService->_x('Placeholder font family', 'design-builder-token-data', 'municipio'),
            'Placeholder font weight' => $this->wpService->_x('Placeholder font weight', 'design-builder-token-data', 'municipio'),
            'Placeholder background color' => $this->wpService->_x('Placeholder background color', 'design-builder-token-data', 'municipio'),
            'Caption settings' => $this->wpService->_x('Caption settings', 'design-builder-token-data', 'municipio'),
            'Caption font size' => $this->wpService->_x('Caption font size', 'design-builder-token-data', 'municipio'),
            'Caption line height' => $this->wpService->_x('Caption line height', 'design-builder-token-data', 'municipio'),
            'Caption color' => $this->wpService->_x('Caption color', 'design-builder-token-data', 'municipio'),
            'Colors' => $this->wpService->_x('Colors', 'design-builder-token-data', 'municipio'),
            'Selects the token families used by each notice state.' => $this->wpService->_x('Selects the token families used by each notice state.', 'design-builder-token-data', 'municipio'),
            'Info State' => $this->wpService->_x('Info State', 'design-builder-token-data', 'municipio'),
            'Selects the token family used for informational notices.' => $this->wpService->_x('Selects the token family used for informational notices.', 'design-builder-token-data', 'municipio'),
            'Danger State' => $this->wpService->_x('Danger State', 'design-builder-token-data', 'municipio'),
            'Selects the token family used for danger notices.' => $this->wpService->_x('Selects the token family used for danger notices.', 'design-builder-token-data', 'municipio'),
            'Warning State' => $this->wpService->_x('Warning State', 'design-builder-token-data', 'municipio'),
            'Selects the token family used for warning notices.' => $this->wpService->_x('Selects the token family used for warning notices.', 'design-builder-token-data', 'municipio'),
            'Success State' => $this->wpService->_x('Success State', 'design-builder-token-data', 'municipio'),
            'Selects the token family used for success notices.' => $this->wpService->_x('Selects the token family used for success notices.', 'design-builder-token-data', 'municipio'),
            'Product' => $this->wpService->_x('Product', 'design-builder-token-data', 'municipio'),
