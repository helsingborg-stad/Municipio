<?php 
    ...
    'fields' => array(
        0 => array(
            ...
            'name' => 'municipio_overlay_vibrant',
            'type' => 'group',
            'instructions' => __('Set a colourful overlay, the color will be overlayed on images.', 'municipio'),
            'required' => 0,
            'conditional_logic' => 0,
            'wrapper' => array(
                'width' => '',
        ...
        1 => array(
            'key' => 'field_615c1bc3772e5',
            'label' => __('Neutral overlay colour', 'municipio'),
            'name' => 'municipio_overlay_neutral',
            'type' => 'group',
            'instructions' => __('Set a neutral overlay, the color will be overlayed on images.', 'municipio'),
            'required' => 0,
            'conditional_logic' => 0,
            'wrapper' => array(
                'width' => '',
