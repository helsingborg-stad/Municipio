...
final class ButtonSettingsTest extends TestCase
{
    ...
    public function testHeaderTriggerButtonsUseTheSharedButtonSettingsWithAnInheritedColorByDefault(): void
    {
    ...
    public function testMegaMenuButtonVariantsUseTheSharedStyleSizeAndColorSettings(): void
    {
