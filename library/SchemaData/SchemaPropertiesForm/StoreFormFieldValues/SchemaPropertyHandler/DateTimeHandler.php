 ...
 */
class DateTimeHandler implements SchemaPropertyHandlerInterface
{
    /**
     * Constructor.
     */
    ...
    {
        return $fieldType === 'date_time_picker' && in_array('\DateTimeInterface', $propertyTypes) && !empty($value) && date_create($value) !== false;
    }
