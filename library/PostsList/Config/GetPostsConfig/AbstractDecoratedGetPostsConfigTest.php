...
class AbstractDecoratedGetPostsConfigTest extends TestCase
{
    ...
    public function testProxiesInnerConfig(): void
    {
        ...
        $this->assertSame($innerConfig->paginationEnabled(), $instance->paginationEnabled());
        $this->assertSame(
            $innerConfig->isFacettingTaxonomyQueryEnabled(),
            $instance->isFacettingTaxonomyQueryEnabled(),
        );
