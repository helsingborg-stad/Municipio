...
type LocalIcon = React.FC<{ width: number, height: number }>;

const RadioIcon: LocalIcon = ({ width, height }) => {
    return (
...
const MultiSelectIcon: LocalIcon = ({ width, height }) => {
    return (
        <svg width={width} height={height} viewBox="0 0 52 52" enable-background="new 0 0 52 52" xmlns="http://www.w3.org/2000/svg">
