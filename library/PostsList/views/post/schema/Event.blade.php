@segment([
    ...
    @slot('aboveContent')
        ...
        @if(!empty($getSchemaEventHasMoreOccasions($post)))
            @element([
                'classList' => ['u-margin__top--2', 'u-padding__x--1', 'u-border--1', 'u-border__color--primary', 'u-color__text--primary', 'u-position--relative', 'u-preloader--no-border', 'u-display--inline-block', 'u-rounded']
            ])
