...
class MapComponentAttributesGenerator
{
    ...
    public function generate(): mixed
    {
        ...
        return [
            'markers' => array_map(fn($place) => $this->mapPlaceToPin($place), $places),
            'lat' => $this->getStartLatitude($places),
            'lng' => $this->getStartLongitude($places),
            'zoom' => 14,
        ];
    }
     ...
     */
    private function mapPlaceToPin(Place $place): ?object
    {
