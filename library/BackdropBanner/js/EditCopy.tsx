...
type BackdropBannerPanelProps = {
	tabKey: string;
	tabDefs: BackdropBannerTab[];
	activeTabId?: string;
	handleTabMouseDownCapture: (event: MouseEvent<HTMLDivElement>) => void;
	onSelectTab: (tabName?: string) => void;
};

const BackdropBannerPanel: ComponentType<BackdropBannerPanelProps> = ({
	tabKey,
	tabDefs,
	activeTabId,
	handleTabMouseDownCapture,
	onSelectTab,
}) => {
	return (
		<div
		...
		<div {...blockProps}>
			...
			{rowBlocks.length > 0 ? (
				<BackdropBannerPanel
					...
					handleTabMouseDownCapture={handleTabMouseDownCapture}
